      ...
      <div className="container w-full py-10">
        ...
        <form onSubmit={handleSubmit} className="sections flex justify-between gap-24">
          <div className="left flex-1 flex flex-col gap-2.5 justify-between">
            <label className="text-gray-500 text-lg" htmlFor="username">Username</label>
            <input
            ...
            />
            <label className="text-gray-500 text-lg" htmlFor="email">Email</label>
            <input
              className="p-5 border border-solid border-slate-400 rounded"
              name="email"
              type="email"
              ...
              onChange={handleChange}
            />
            <label className="text-gray-500 text-lg" htmlFor="password">Password</label>
            <input
              className="p-5 border border-solid border-slate-400 rounded"
              name="password"
              type="password"
              onChange={handleChange}
            />
            <label className="text-gray-500 text-lg" htmlFor="file">Profile Picture</label>
            <input
              className="p-5 border border-solid border-slate-400 rounded"
              type="file"
              onChange={(e) => setFile(e.target.files[0])}
            />
            <label className="text-gray-500 text-lg" htmlFor="country">Country</label>
            <input
              className="p-5 border border-solid border-slate-400 rounded"
              name="country"
              type="text"
              ...
              onChange={handleChange}
            />
            <button type="submit" className="border-none p-5 text-white font-medium text-lg bg-green-600 cursor-pointer">
              Register
            </button>
          </div>
          <div className="right flex-1 flex flex-col justify-between">
            ...
            <label className="text-gray-500 text-lg" htmlFor="phone">Phone Number</label>
            <input
              className="p-5 border border-solid border-slate-400 rounded"
              name="phone"
              type="text"
